...
const _0x5e6f = atob('blhsOG1UblZVb1VvR1VVTXJWb1Z2'); // Base64 encoded
...
// Method 3: XOR encoding (simple obfuscation)
...
// Clean up obfuscation variables (optional - makes debugging harder)
try {
    delete _0x1a2b;
    delete _0x3c4d;
    delete _0x5e6f;
    ...
    // Ignore cleanup errors in strict mode
}
